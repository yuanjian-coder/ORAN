...
def file_to_json(file_name,num):
	...
	end_time=time() 
	if(num==1):
		print('Size after JSON encoding:'+str(sys.getsizeof(j))+'B')
...
print('100 fields JSON decoding time：'+str(time4/10000*1000)+'ms')
print('----------')
...
print('500 fields JSON decoding time：'+str(time6/10000*1000)+'ms')
